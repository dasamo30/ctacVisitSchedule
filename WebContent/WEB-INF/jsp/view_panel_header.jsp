...
<html>
  <head>
    ...
    <title>Web | Visit Schedule </title>
    ...
    <!-- datetimepicker -->
    <link rel="stylesheet" href="${contextPath}/plugins/datetimepicker/bootstrap-datetimepicker.min.css">
    <!-- Daterange picker -->
    ...
    <!-- tagsinput -->
    <link rel="stylesheet" href="${contextPath}/plugins/tagsinput/bootstrap-tagsinput.css">
     <!-- Theme style -->
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="${contextPath}/panel/home" class="logo">
          ...
          <span class="logo-mini"><b>C</b>TAC</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Visit Schedule</b></span>
        </a>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="${contextPath}/images/user.png" class="user-image"  alt="User Image">
                  <span class="hidden-xs"><%=sesion.getAttribute("nombre").toString()%></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="${contextPath}/images/user.png" class="img-circle" alt="User Image">
                    <p>
