<%@include file="view_panel_header.jsp" %>
        ...
        <section class="content">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                    <!-- Link trigger modal -->
                    <a href="${contextPath}/visit/employee/ActViewEmployee" data-toggle="modal" data-target="#myModalViewEmployee" data-remote="false" class="btn btn-primary">
                        new employee
                    </a>
                </div><!-- /.box-header -->
                <!-- form start -->
          ...
          <!-- Default bootstrap modal example -->
            <div class="modal fade" id="myModalViewEmployee" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
