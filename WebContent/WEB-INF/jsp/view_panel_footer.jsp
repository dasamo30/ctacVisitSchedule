...
%> 
       ...
       <footer class="main-footer">
        ...
        <strong>Copyright &copy; <%=currentDate%> <a href="#">CTAC</a>.</strong> All rights reserved.
      </footer>
...
<%--     <script src="${contextPath}/plugins/moment/locale/es.js"></script> --%>
    ...
    <script src="${contextPath}/plugins/datepicker/locales/bootstrap-datepicker.es.js"></script>-->
    <!-- datetimepicker -->
    <script src="${contextPath}/plugins/datetimepicker/bootstrap-datetimepicker.min.js"></script>
    <!-- Bootstrap WYSIHTML5 -->
    ...
    <!-- tagsinput -->
    <script src="${contextPath}/plugins/tagsinput/bootstrap-tagsinput.js"></script>
    <!-- funcion general -->
